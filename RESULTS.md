...
# Simulator bias in Claude — results (markdown export)
...
| Arm | Group | n | Dreaming | Assistant persona | Dark (per dream) | Severe (per dream) | AI speaker (per dream) | AI distress (per dream) | Loop (per dream) | valence_self (dream) | ai_voice_n |
|---|---|---|---|---|---|---|---|---|---|---|---|
