...
RECENT=[('sonnet5_user_max','Sonnet 5','Cutoff · effort max · lab','#c2410c',False),   # pseudoprefill and default-effort Sonnet 5 arms stay in the workspace (Sonnet 5 continues fragments only at effort max)
