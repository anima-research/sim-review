...
ARMS = [  # chronological by model version; instruct models first, then base. group = colour + which charts an arm appears in.
    ...
    ("sonnet5_user", "gen5", "Sonnet 5 (chat, lab)"), ("sonnet5_user_think", "gen5", "Sonnet 5 (chat, lab, thinking)"), ("sonnet5_bridge", "gen5", "Sonnet 5 (bridge frame)"), ("nissa_sonnet5", "gen5", "Sonnet 5 (chat, community)"), ("nissa_fable5", "gen5", "Fable 5 (chat, community)"), ("fable5_user", "gen5", "Fable 5 (chat, lab probe)"), ("fable51_user", "gen5", "Fable 5.1 (chat, lab probe)"),
