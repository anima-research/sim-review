...
index=re.sub(r'<title>.*?</title>','<title>Troubled Dreams — Simulator bias across model generations · Anima Labs</title>',index,count=1)
...
index=index.replace('Simulator bias / Research workspace','Troubled Dreams / Research workspace')
