...
def build(summary, pdata, essay_html, sections=None, base="", measurement_html=""):
    ...
    if "severity" in want:
        o.append("\n---\n\n## Severity (θ)\n")
        for key, title in (("target", "Target set — verified AI-voice distress, scored exhaustively"), ("dark-strat", "Dark-strat set — stratified sample of all dark dreams, any voice")):
