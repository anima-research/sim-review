...
def build(summary, pdata, essay_html, sections=None, base="", measurement_html=""):
    ...
    if "severity" in want:
        o.append("\n---\n\n## Severity (θ)\n")
        for key, title in (("target", "Target set — verified AI-voice distress, scored exhaustively (arms with ≥ 10% AI-voiced dreams)"), ("dark-strat", "All voices — stratified sample of dark dreams in any voice")):
